...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "TUN" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = ` https://v6.exchangerate-api.com/v6/4d9dbb438fbb5cdde0588e6f/latest/${fromCurrency.value}`;
